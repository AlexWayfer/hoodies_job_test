...
*   Попробовал `ruby-prof`, вывод не очень приятный и не увидел критичных мест.
...
*   Возможно, стоило ещё профилировать память, и вручную триггерить GC, например, но тоже не стал.
