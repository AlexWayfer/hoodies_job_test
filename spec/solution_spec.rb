...
RSpec.describe Solution do
  subject { JSON.load_file result_file_name }

  before do
    File.write data_file_name, data

    File.write result_file_name, ''

    described_class::GenerateReport.new.call(io: io).bind do |report|
      described_class::SaveReport.new.call report: report, result_file_name: result_file_name
    end
  end
  ...
  let(:io) { File.open data_file_name }
